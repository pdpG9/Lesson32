...
import com.example.lesson32.adapters.GroupAdapter
...
import com.example.lesson32.fragments.GroupFragment
import com.example.lesson32.models.*
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // loadDate()
        ...
        loadFragmentTodata(data)
        Log.d("TTT","groups MainAc.. ${data.size}")
        pager.adapter = adapter
        adapter.setOnEditClickListener { pair ->
...
//            dialog.setAge(s.age)
        ...
        adapter.setOnDeleteClickListener { pair ->
            ...
            fragments[page].notifyStudentRemove(itemIndex)
        }
    }
